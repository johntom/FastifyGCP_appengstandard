...
module.exports = async function (fastify, opts) {
  ...
  fastify.get("/works/:posttitle/:menu/:imagefilename/:imagetitle",

    async (req, reply) => {
      let { posttitle, menu, imagefilename, imagetitle } = req.params;
     ...
     //99 let sessionId = req.cookies.sessionId
      ...
      if (menu === -1) {
        ...
        if (posttitle === '-99') {
          ...
          <li>
          <a
          hx-get="/api_view/works/STATEMENT/${menu}/${imagefilename}/${imagetitle}"
           hx-target='body'
          hx-swap="outterHTML"
        ...
        >statement 00
               ...
               <li>
            <a
            hx-get="/api_view/works/VITAE/${menu}/${imagefilename}/${imagetitle}"
             hx-target='body'
            hx-swap="outterHTML"
          ...
          >vitae 00
           ...
           <li>
           <a
           hx-get="/api_view/works/CONTACT/${menu}/${imagefilename}/${imagetitle}"
            hx-target='body'
           hx-swap="outterHTML"
...
>contact 0
   ...
   landingworks - ${selectedmenuindex} / ${menu}  </a>
    ...
    <li><a hx-get="/api_view/works/STATEMENT/${menu}/${imagefilename}/${imagetitle}" hx-target='body' hx-swap="outterHTML" 
    
    hx-on="htmx:beforeRequest:openViewWorks('STATEMENT','${menu}','${imagefilename}','${imagetitle}')">
    statement </a>
    </li>

    <li><a hx-get="/api_view/works/VITAE/${menu}/${imagefilename}/${imagetitle}" hx-target='body' hx-swap="outterHTML" 
    ...
    <li>
    <a hx-get="/api_view/works/CONTACT/${menu}/${imagefilename}/${imagetitle}" hx-target='body' hx-swap="outterHTML" 
  ...
  fastify.get("/landing", {
    ...
    //99  let sessionId = req.cookies.baz;

      console.log('"""""""""""""""""""')
        //99console.log('"sessionId======================', sessionId)
      console.log('"""""""""""""""""""')
      ...
      rec.selectedmenuindex = selectedmenuindex
        ...
        //99rec.sessionId = sessionId;//sid//sessionId
       //99 rec.aCookieValue = '';//aCookieValue
      // rec.selectedmenu_ = '';
       //99 rec.selectedmenu_ = '1';

       //99 console.log('"""""""""""""""""""sid===========', sessionId)
       //99 console.log('"""""""""""""""""""sid===========')
      ...
      return reply.view('_landing.njk', {
        ...
        selectedmenuindex: selectedmenuindex, displaywork: displaywork
          //99, sessionId: sessionId

      });
    });
  fastify.get("/landingworks/:selectedmenuindex/:menu/:imagefilename/:imagetitle", {


  },
    async (req, reply) => {
      let { selectedmenuindex, menu, imagefilename, imagetitle } = req.params;

       //99 let sessionId = req.cookies.baz;
      //99  console.log('"""""""""""""""""""')
      //99  console.log('"sessionId======================', sessionId)
      //99  console.log('"""""""""""""""""""')
      //   await resetenv('landing', fastify, reply)
...
// <li>
// <a hx-get="/api_view/works/CONTACT/${menu}/${imagefilename}/${imagetitle}"
// hx-target='body'
// hx-swap="outterHTML"
// hx-on="htmx:beforeRequest:openView('CONTACT')"
// >contact 000
...
// </li> 
  ...
  >statement 000
   ...
   <li>
 <a hx-get="/api_view/works/VITAE/${menu}/${imagefilename}/${imagetitle}"
  hx-target='body'
 hx-on="htmx:beforeRequest:openView('VITAE')"
>vitae 000
</a>
